...
var mergeModules = require("iconv-lite/lib/helpers/merge-exports")
...
module.exports.getCodec = function getCodec (encoding) {
  if (!module.exports.encodings) {
    var raw = require("iconv-lite/encodings")
...
module.exports.enableStreamingAPI = function enableStreamingAPI (streamModule) {
  ...
  var streams = require("iconv-lite/lib/streams")(streamModule)
